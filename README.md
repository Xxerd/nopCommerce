...
## Architectural with respect to observability

![nopCommerce Grafana dashboard](./AS/imagens/Architecture_flow.png)
...
![nopCommerce Grafana dashboard](./AS/imagens/grafana.png)


## Jaegar Trace

![nopCommerce Jaeger trace](./AS/imagens/jaeger.png)
